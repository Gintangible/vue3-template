<template>
  ...
  >
    <div class="form-content box-shadow_radius">
      ...
      <BirthdayField v-model="insured.birthday" required />
      <GenderField v-model="insured.gender" required />
    </div>
    <!-- 提交按钮 -->
    {{ insured }}
...
import BirthdayField from '@/modelComponents/BirthdayField.vue';
import GenderField from '@/modelComponents/GenderField.vue';
